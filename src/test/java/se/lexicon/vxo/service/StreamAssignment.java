...
public class StreamAssignment {
    ...
    public void task3(){
        long amount = 0;
        int expected = 90;
        Predicate<Person> lastName = person -> person.getLastName().equalsIgnoreCase("Andersson");
        Stream<Person> andersson = people.stream().filter(lastName);
        amount = andersson.count();
    ...
    public void task4(){
        ...
        Predicate<Person> ifFemale = person -> person.getGender().equals(Gender.FEMALE);
    ...
    public void task6(){
        ...
        Stream<Person> hasErik = people.stream()
                .filter(nameIsErik);
        result = hasErik.toArray(size -> new Person[size]);
    ...
    public void task7(){
        ...
        Predicate<Person> specificId = person -> person.getPersonId() == 5436;
    ...
    public void task9(){
        ...
        Predicate<Person> oldPeople = person -> person.getDateOfBirth().isBefore(date);
